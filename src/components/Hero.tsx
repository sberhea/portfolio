const Hero = ({}) => {
  return (
    ...
    <div className="px-4 md:px-8 tracking-normal font-stretch-expanded space-y-3 md:space-y-4 text-xl md:text-2xl leading-relaxed text-black italic">
      ...
      <p>  
      She has four years of experience as a software engineer specializing in <span className="decoration-fuchsia-400 underline underline-offset-[8px] decoration-wavy">observability</span> at a Fortune 500 company.
      </p>
      <p>
      ...
      <p>
      Selam aims to apply her design, technical, and interpersonal skills toward building <span className="bg-lime-300">technology that serves people responsibly</span>. 
      </p>
      <p>
